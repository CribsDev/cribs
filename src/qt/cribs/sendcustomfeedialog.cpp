...
#include "qt/cribs/sendcustomfeedialog.h"
#include "qt/cribs/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CRIBXGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CRIBXGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
