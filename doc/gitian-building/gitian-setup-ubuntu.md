...
The build script we'll be using is contained in the CRIBX github repository ([contrib/gitian-build.py](https://github.com/cribs-project/cribs/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the CRIBX repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CRIBX-Project/CRIBX/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, cribs-detached-sigs, and cribs GitHub repos.
