...
#include "qt/cribs/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            CRIBXGUI* window = static_cast<CRIBXGUI*>(parentWidget());
...
{
    CRIBXGUI* gui = static_cast<CRIBXGUI*>(parentWidget());
...
{
    hide();
    static_cast<CRIBXGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("CRIBS will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your CRIBs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
