...
RESOURCES += src/qt/cribs.qrc src/qt/cribs_locale.qrc

TRANSLATIONS += src/qt/locale/cribs_bg.ts \
                src/qt/locale/cribs_de.ts \
                src/qt/locale/cribs_en.ts \
                src/qt/locale/cribs_es.ts \
                src/qt/locale/cribs_fi.ts \
                src/qt/locale/cribs_fr.ts \
                src/qt/locale/cribs_it.ts \
                src/qt/locale/cribs_ja.ts \
                src/qt/locale/cribs_pl.ts \
                src/qt/locale/cribs_pt.ts \
                src/qt/locale/cribs_ru.ts \
                src/qt/locale/cribs_sk.ts \
                src/qt/locale/cribs_sv.ts \
                src/qt/locale/cribs_vi.ts \
                src/qt/locale/cribs_zh_CN.ts \
                src/qt/locale/cribs_zh_TW.ts
