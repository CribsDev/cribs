...
#include "qt/cribs/furabstractlistitemdelegate.h"
#include "qt/cribs/txviewholder.h"
#include "qt/cribs/tooltipmenu.h"
#include "qt/cribs/sendmultirow.h"
#include "qt/cribs/coldstakingmodel.h"
#include "qt/cribs/contactsdropdown.h"
#include "qt/cribs/addressholder.h"
...
public:
    explicit ColdStakingWidget(CRIBXGUI* parent);
    ~ColdStakingWidget();
