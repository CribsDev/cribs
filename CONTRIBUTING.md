Contributing to CRIBX Core
============================

The CRIBX Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/cribs-project/cribs/blob/master/doc/translation_process.md)
...
The following applies to code changes to the CRIBX Core project, and is not to be
confused with overall CRIBX Network Protocol consensus changes.

Whether a pull request is merged into CRIBX Core rests with the project merge
...
Patches that change CRIBX consensus rules are considerably more involved than
...
Where a patchset proposes to change the CRIBX consensus, it must have been
...
The project leader is the release manager for each CRIBX Core release.
