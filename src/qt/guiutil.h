...
/** Utility functions used by the CRIBX Qt UI.
 */
namespace GUIUtil
{
...
// Render CRIBX addresses in monospace font
...
// Parse "cribs:" URI into recipient object, return true on successful parsing
