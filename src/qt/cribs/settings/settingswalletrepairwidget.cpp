...
#include "qt/cribs/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/cribs/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CRIBXGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CRIBXGUI::handleRestart()
