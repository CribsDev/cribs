...
#include "qt/cribs/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/cribs/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(CRIBXGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableCRIB,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableCRIB,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableCRIB,
    ...
    connect(ui->pushButton_UnspendableCRIB, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableCRIB);});
    ...
    if (parent)
        connect(parent, &CRIBXGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
