...
from test_framework.test_framework import CribsTestFramework
...
class ReorgStakeTest(CribsTestFramework):
    ...
    def check_money_supply(self, expected_piv, expected_zpiv):
        ...
        # verify that nodes have the expected CRIB and zCRIB supply
        for node in g_info:
            assert_equal(node['moneysupply'], DecimalAmt(expected_piv))
            for denom in node['zCRIBsupply']:
                assert_equal(node['zCRIBsupply'][denom], DecimalAmt(expected_zpiv[denom]))
    ...
    def run_test(self):
        ...
        # Check CRIB and zCRIB supply at the beginning
        # ------------------------------------------
        # zCRIB supply: 2 coins for each denomination
        ...
        # CRIB supply: block rewards minus burned fees for minting
        ...
        # Verify that CRIB and zCRIB supplies were properly updated after the spends and reorgs
        self.log.info("Check CRIB and zCRIB supply...")
