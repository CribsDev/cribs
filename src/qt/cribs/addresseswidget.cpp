...
#include "qt/cribs/forms/ui_addresseswidget.h"
#include "qt/cribs/addresslabelrow.h"
#include "qt/cribs/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(CRIBXGUI* parent) :
    PWidget(parent),
