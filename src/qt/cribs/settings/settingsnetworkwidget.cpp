...
#include "qt/cribs/settings/settingsnetworkwidget.h"
#include "qt/cribs/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/cribs/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CRIBXGUI* _window, QWidget *parent) :
