...
#ifndef CRIBX_ZCRIBTRACKER_H
#define CRIBX_ZCRIBTRACKER_H
...
public:
    CzCRIBTracker(CWallet* parent);
    ~CzCRIBTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzCRIBWallet* zCRIBWallet = NULL);
