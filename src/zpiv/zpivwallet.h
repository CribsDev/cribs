...
#ifndef CRIBX_ZCRIBWALLET_H
#define CRIBX_ZCRIBWALLET_H
...
public:
    ...
    void GenerateDeterministicZCRIB(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCRIB(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
