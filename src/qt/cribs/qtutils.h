...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, CRIBXGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, CRIBXGUI* gui, double posX = 3);
