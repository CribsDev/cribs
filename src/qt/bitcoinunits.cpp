...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(CRIB);
    unitlist.append(mCRIB);
    unitlist.append(uCRIB);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case CRIB:
        return QString("cribs");
    case mCRIB:
        return QString("mcribs");
    case uCRIB:
        return QString::fromUtf8("ucribs");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCRIB)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZCRIB);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCRIB)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZCRIB));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
