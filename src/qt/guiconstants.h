...
/* Cribs GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CRIBX"
#define QAPP_ORG_DOMAIN "cribs.org"
#define QAPP_APP_NAME_DEFAULT "CRIBX-Qt"
#define QAPP_APP_NAME_TESTNET "CRIBX-Qt-testnet"
