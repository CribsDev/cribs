...
#ifndef CRIBX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CRIBX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CRIBX_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
