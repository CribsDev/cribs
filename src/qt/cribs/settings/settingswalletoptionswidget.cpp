...
#include "qt/cribs/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/cribs/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CRIBXGUI* _window, QWidget *parent) :
