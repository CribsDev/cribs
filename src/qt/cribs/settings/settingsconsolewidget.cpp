...
#include "qt/cribs/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/cribs/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CRIBXGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the CRIBX RPC console.") + "<br>" +
