...
#include "qt/cribs/forms/ui_topbar.h"
#include "qt/cribs/lockunlock.h"
#include "qt/cribs/qtutils.h"
#include "qt/cribs/receivedialog.h"
...
TopBar::TopBar(CRIBXGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("CRIBX")
    updateDisplayUnit();
