...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CRIBX features */
        {"cribs", "listmasternodes", &listmasternodes, true },
        {"cribs", "getmasternodecount", &getmasternodecount, true },
        {"cribs", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"cribs", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"cribs", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"cribs", "masternodecurrent", &masternodecurrent, true },
        {"cribs", "startmasternode", &startmasternode, true },
        {"cribs", "createmasternodekey", &createmasternodekey, true },
        {"cribs", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"cribs", "listmasternodeconf", &listmasternodeconf, true },
        {"cribs", "getmasternodestatus", &getmasternodestatus, true },
        {"cribs", "getmasternodewinners", &getmasternodewinners, true },
        {"cribs", "getmasternodescores", &getmasternodescores, true },
        {"cribs", "preparebudget", &preparebudget, true },
        {"cribs", "submitbudget", &submitbudget, true },
        {"cribs", "mnbudgetvote", &mnbudgetvote, true },
        {"cribs", "getbudgetvotes", &getbudgetvotes, true },
        {"cribs", "getnextsuperblock", &getnextsuperblock, true },
        {"cribs", "getbudgetprojection", &getbudgetprojection, true },
        {"cribs", "getbudgetinfo", &getbudgetinfo, true },
        {"cribs", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"cribs", "mnfinalbudget", &mnfinalbudget, true },
        {"cribs", "checkbudgets", &checkbudgets, true },
        {"cribs", "mnsync", &mnsync, true },
        {"cribs", "spork", &spork, true },
...
{
    return "> cribs-cli " + methodname + " " + args + "\n";
}
