...
#include "qt/cribs/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(CRIBXGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &CRIBXGUI::openFAQ);
