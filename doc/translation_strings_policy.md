...
This document provides guidelines for internationalization of the CRIBX Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to CRIBX network</source>
        <translation>
            <numerusform>%n active connection to CRIBX network</numerusform>
            <numerusform>%n active connections to CRIBX network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cribs_en.ts` remains unchanged.
