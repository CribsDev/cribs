...
{
    const char* pszTimestamp = "Cribs 4x new genesis";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x000005458a3bd1b64212483ced3ef5d3c8ba0bf8d425047023b1ef7ee980469e")); 
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1454124731, 5499031, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        
        assert(consensus.hashGenesisBlock == uint256S("000005458a3bd1b64212483ced3ef5d3c8ba0bf8d425047023b1ef7ee980469e"));
        assert(genesis.hashMerkleRoot == uint256S("6efa22c4b0220e7a1b0c3a4ad06bab90e015a79679752409c736157c5c91b4ea"));
        ...
        consensus.nTimeSlotLength                        = 15;
                ...
                // spork keys
        consensus.strSporkPubKey                         = "0215b5cdc02ff182820796d3035deb8b35e5a2fbff8dac13dc833c3e65e52a317e";
        ...
        // validation by-pass
        consensus.nCribsBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nCribsBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
       ...
       // Network upgrades
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight           = 43205;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight        = 43206;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].hashActivationBlock       = uint256S("0x000005458a3bd1b64212483ced3ef5d3c8ba0bf8d425047023b1ef7ee980469e");
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 13);      //! standard
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 63);     //! standard
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nCribsBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nCribsBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        consensus.vUpgrades[Consensus::UPGRADE_NEW_ALGO].nActivationHeight      = 230;
