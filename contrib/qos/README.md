...
This means one can have an always-on cribsd instance running, and another local cribsd/cribs-qt instance which connects to this node and receives blocks from it.
